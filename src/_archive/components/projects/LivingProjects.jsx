  ...
  return (
    <SectionWrapper>
      <Container>
        ...
        <IntroBlock>
          <IntroTitle>
            Living spaces carry emotion.
            <br />
            They hold celebrations, quiet evenings, and everything in between.
          </IntroTitle>
          <TitleAccent />
          <IntroDesc>
            We design layouts that feel open but grounded — balancing media
            systems, storage clarity, and layered lighting that shifts with the
            day.
          </IntroDesc>
        </IntroBlock>
